...
#utilizes magnetic sensor for accurate distance measuring and limit switch for collision detection
#***************************************MOTOR SET UP****************************************
...
class table:
    ...
    def move(dist,freq=2000,pin3=13):
        ...
        for i in range(abs(dist)):
			...
			#if the switch is triggered then end the table movement
...
#todo change line to use the (magnet) table move function + add gui
def line(ini=0):
    if ini>0:
        table.home()
        table.move(260)
